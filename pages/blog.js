                ...
                <div className="container">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 col-sm-8 col-12 blog-sidebar">
                        ...
                        <div className="post-box-blog">
                            ...
                            <div className="recent-box-blog">
                                <div className="recent-img">
                                <img className="img-fluid" src="images/post-img-02.jpg" alt="" />
                                </div>
                                <div className="recent-info">
                                <ul>
                                    <li><i className="zmdi zmdi-account" />Posted By : <span>Rubel Ahmed</span></li>
                            ...
                            <div className="recent-box-blog">
                                <div className="recent-img">
                                <img className="img-fluid" src="images/post-img-03.jpg" alt="" />
                                </div>
                                <div className="recent-info">
                                <ul>
                                    <li><i className="zmdi zmdi-account" />Posted By : <span>Rubel Ahmed</span></li>
                        ...
                        <div className="blog-tag-box align-content-center">
                            ...
                            <li className="list-inline-item"><a href="#">Nature</a></li>
                            <li className="list-inline-item"><a href="#">Italian</a></li>
                            <li className="list-inline-item"><a href="#">Bootstrap4</a></li>
