                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-6 col-sm-12 text-center shadow-lg mb-5 pt-3 pl-4 pr-4">
                                <div className="inner-column mb-0 mt-3 text-center">
                                    <h1 className="">
                                        Welcome To{" "}
                                        <span className="">FEASTA, {user}</span>
                                    </h1>
                                    <hr
                                        style={{ color: "var(--feasta-sec)" }}
                                    />
                                    ...
                                    <p>
                                        ...
                                        suscipit feugiat. Ut at pellentesque
                                        ante, sed convallis arcu. Nullam
                                        facilisis, eros in eleifend luctus, odio
                                        ante sodales augue, eget lacinia lectus
                                        erat et sem.{" "}
                                    </p>
                                    <p>
                                        Sed semper orci sit amet porta placerat.
                                        Etiam quis finibus eros. Sed aliquam
                                        metus lorem, a pellentesque tellus
                                        pretium a. Nulla placerat elit in justo
                    ...
                    <div>
                        <div className="row">
                            <div className="col-md-8 ml-auto mr-auto text-center">
                                <p className="lead ">
                                    " If you're not the one cooking, stay out of
                                    the way and compliment the chef. "
                                </p>
                                    ...
                                    <div className="carousel-inner mt-4">
                                        <div className="carousel-item text-center active">
                                            ...
                                            <p className="m-0 pt-3">
                                                ...
                                                eu sem tempor, varius quam at,
                                                luctus dui. Mauris magna metus,
                                                dapibus nec turpis vel, semper
                                                malesuada ante. Idac bibendum
                                                scelerisque non non purus.
                                                Suspendisse varius nibh non
                                                aliquet.
                                            </p>
                                        </div>
                                        ...
                                        <div className="carousel-item text-center">
                                            ...
                                            <p className="m-0 pt-3 card-body">
                                                Lorem ipsum dolor sit amet,
                                                consectetur adipiscing elit. Nam
                                                eu sem tempor, varius quam at,
                                                luctus dui. Mauris magna metus,
