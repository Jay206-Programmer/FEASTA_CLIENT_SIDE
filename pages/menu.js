...
export default function Menu() {
    ...
    async function canteenData() {
        const requests = await axios.get(
            "https://feasta-postgres.herokuapp.com/canteens/"
        );
                                ...
                                return (
                                    <>
                                        <button
                                            ...
                                            className="btn btn-lg shadow-lg mb-2 mt-2 align-content-center"
                                            id="v-pills-settings-tab"
                                            value={data.admin_id}
                                            onClick={() => {
                                                setadmin_id(data.admin_id);
                                            }}
                                        >
                                            {data.canteen_name}
                                        </button>
                            ...
                            <div className="row">
                                <div className="col-lg-12 text-center">
                                    <div className="heading-title text-center">
                                        ...
                                        <p>
                                            {" "}
                                            Delicious items just waiting for
                                            you...
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="row inner-menu-box">
                                        ...
                                        {cate.map((data) => {
                                            return (
                                                <button
                                                    ...
                                                    className="mt-2 nav-link shadow-lg"
                                                    id="v-pills-settings-tab"
                                ...
                                <div className="col-9">
                                    ...
                                    >
                                        {table.length != 0 ? (
                                            <div
                                                className="tz-gallery tab-pane fade show active"
                                                id="v-pills-home"
                                                role="tabpanel"
